...
Although you wont't have time to take extensive notes in inspectional reading, when you start getting answers to the following questions, you should note them anyway for when you come back to the book for an analytical read whether in a week or in months[^3].
...
[^3]: See Inspection/Structural notes section.
...
You must know what kind of book you are reading, and you should know this as early in the process as possible, preferably before you begin to read. This is because the types of questions you ask of different kinds of books and the way you answer them is different. A book on physics is approached differently than a book on morals. We have to modify the basic questions and how you answer them for each.
...
How do you do so? By applying the rules in inspectional reading part I.
...
How do you do so? By applying the rules in inspectional reading part II.

Note: even if the author gives you the unity of his work, don't stop there. You'll have your own version of it when you're done.
...
Your outlines may not matche the author's chapter divisions. He did it in order to write the book. You're doing it in order to read the book. Even if yours is not as good as his. But do use his titles, headings and subheadings as guides.

As you outline this book in analytical reading (by deepening your inspectional reading), your original unity that you wrote during inspectional reading could change as your understanding deepens

### Define Problem(s) Author Tried to Solve
