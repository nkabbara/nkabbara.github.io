...
Moonwalking is a great companion to [Unlimited Memory](/books/unlimited-memory). UM takes on a howto and self help format while Moonwalking is participitory journalism. It gives UM context and purpose. It also sheds more light on some of the techniques in the way of tips from world champions. The main reason I read it though was to help me shape my [book on tango](/tango/book) which hasn't been relegated to a genre yet.
...
If practice makes perfect, then why aren't you the fastest typist in the words since you type everyday? Because you're in the autonomous state.
